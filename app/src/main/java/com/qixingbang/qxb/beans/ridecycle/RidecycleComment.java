...
public class RidecycleComment {
    ...
    public static RidecycleComment fromJsonObject(JSONObject jsonObject) {
        RidecycleComment comment = new RidecycleComment();
    ...
    public static List<RidecycleComment> fromJsonArray(JSONArray jsonArray) {
        List<RidecycleComment> list = new ArrayList<>();
    ...
    public static void fromJsonArray(List<RidecycleComment> list, JSONArray jsonArray) {
        list.clear();
        int length = jsonArray.length();
        if (length > 0) {
            for (int i = 0; i < length; i++) {
